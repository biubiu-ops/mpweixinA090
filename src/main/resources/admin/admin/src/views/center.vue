  ...
  <div :style='{"padding":"30px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='xuesheng'"  label="运动次数" prop="yundongcishu">
          <el-input v-model="ruleForm.yundongcishu" readonly              placeholder="运动次数" clearable></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'xuesheng' ==this.flag && this.ruleForm.yundongcishu&&(!isIntNumer(this.ruleForm.yundongcishu))){
       this.$message.error(`运动次数应输入整数`);
        return
      }
