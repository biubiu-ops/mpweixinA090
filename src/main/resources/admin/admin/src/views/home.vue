...
<div class="content" :style='{"padding":"30px"}'>
	...
	<!-- echarts -->
	<!-- 1 -->
	<div class="type1" :style='{"alignContent":"flex-start","padding":"10px 20px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto"}'>
		<div id="yundongdakaChart1" class="echarts1" v-if="isAuth('yundongdaka','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
// 1234 竖
        ...
        var yundongdakaChart1 = echarts.init(document.getElementById("yundongdakaChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                yundongdakaChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    yundongdakaChart1.resize();
                };
            }
        });
      })
